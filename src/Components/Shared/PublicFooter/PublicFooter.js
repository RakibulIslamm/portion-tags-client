                ...
                <div className="flex justify-between px-[80px] py-10">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400 space-y-2">
                            <li>
                                <Link to="https://flowbite.com" className="hover:underline">Who We Are</Link>
                            </li>
                            <li>
                                <Link to="https://tailwindcss.com/" className="hover:underline">What We Offer</Link>
                            </li>
                            <li>
                                <Link to="https://tailwindcss.com/" className="hover:underline">Product LineUp</Link>
                            </li>
                            <li>
                                <Link to="https://tailwindcss.com/" className="hover:underline">Buy Parts</Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400 space-y-2">
                            <li>
                                <Link to="https://github.com/themesberg/flowbite" className="hover:underline ">Structural Bolts</Link>
                            </li>
                            <li>
                                <Link to="https://discord.gg/4eeurUVvTy" className="hover:underline">Saws</Link>
                            </li>
                            <li>
                                <Link to="https://discord.gg/4eeurUVvTy" className="hover:underline">Fastener Assortments</Link>
                            </li>
                            <li>
                                <Link to="https://discord.gg/4eeurUVvTy" className="hover:underline">Grinding Wheels</Link>
                            </li>
                            <li>
                                <Link to="https://discord.gg/4eeurUVvTy" className="hover:underline">Tape Measures</Link>
                            </li>
                            <li>
                                <Link to="https://discord.gg/4eeurUVvTy" className="hover:underline">Power Tools</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400 space-y-2">
                            <li>
                                <Link to="/" className="hover:underline">Part Plus Car Care Center</Link>
                            </li>
                            <li>
                                <Link to="/" className="hover:underline">Training</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
