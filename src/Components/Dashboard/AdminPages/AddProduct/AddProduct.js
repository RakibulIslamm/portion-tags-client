    ...
    return (
        <div className="w-full h-screen flex justify-center items-center flex-col">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-8/12 xs:w-full sm:w-full flex items-center flex-col">
                ...
                <input className="bg-gray-200 px-5 py-3 block w-8/12 outline-none focus:bg-white border focus:border-gray-500 rounded my-2" type="text" {...register("shortDesc", { required: true, minLength: 30, maxLength: 200 })} placeholder="Short Dscription" />
                ...
                <input className="bg-gray-200 px-5 py-3 block w-8/12 outline-none focus:bg-white border focus:border-gray-500 rounded my-2" type="file" {...register("img", { required: true })} placeholder="Image url" />
